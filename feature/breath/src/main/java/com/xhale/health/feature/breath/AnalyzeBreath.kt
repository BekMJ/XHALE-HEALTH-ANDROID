...
class AnalyzeBreathUseCase(
    ...
    private val perDeviceGasFit = mapOf(
        ...
        "3BBF9785" to GasFitCoefficients(-12.7602, 35.2773, 0.7938, 0.0),
        "4F2F6B63" to GasFitCoefficients(-12.012171684817618, 22.527506773281576, 1.0, 0.0),
        "6C8A4BC7" to GasFitCoefficients(0.0001, 28.0872, 0.5, 7.0),
        "6F19F9D0" to GasFitCoefficients(-1.8432432432439438, 18.34507990192077, 1.0, 4.999999999999998),
        "794093CF" to GasFitCoefficients(-0.4, 23.116, 0.5, 5.7426),
        "7ED2FA3A" to GasFitCoefficients(-11.3645, 142.4643, 12.0, 8.0),
        ...
        "D1A07CD4" to GasFitCoefficients(-8.874, 118.3664, 12.0, 6.7875),
        "D92EC0CB" to GasFitCoefficients(0.0, 21.3229, 0.6668, 0.0),
        "DC3F9A7B" to GasFitCoefficients(1.939, 36.6784, 3.697, 6.4707),
        ...
        "F2E4CB88" to GasFitCoefficients(-2.2851, 25.458, 6.0296, 1.4817),
        "F685F16F" to GasFitCoefficients(-9.6988, 78.8389, 11.3961, 1.1829),
